...
Original file is located at
    https://colab.research.google.com/drive/1fXI7pUjkqNuh1CiBzZQXzeqjnmMHfW5t
...
suffer from **conditional shift** (distribution shifts across domains) and **label shift** (the class priors change resulting in class-imbalance).
...
over-represented class, causing RCT for **misalignment**.
...
SPDIM Learns a full SPD reference matrix $\Phi_j$
...
RCT to misaligned: the recentered features no longer align with
